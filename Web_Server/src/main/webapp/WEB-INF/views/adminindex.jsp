...
<!-- 			<a class="btn btn-danger toright" href="#">删除选中</a> -->
			<a class="btn btn-primary toright logomgn" href="${APP_PATH }/addproblem">添加</a>
					<tr>
						<td width="10%">#</td>
					...
					<tr style="height:60px;">
						...
						<td><a class="btn btn-primary" href="${APP_PATH }/touptpro/${pro.proId }">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="${APP_PATH }/deletepro/${pageInfo.pageNum }/${pro.proId }">删除</a></td>
					</tr>
					</c:forEach>		
				</table>
				</form>
